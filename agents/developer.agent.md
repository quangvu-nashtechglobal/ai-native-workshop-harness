...
#dev out-design #design; obj <components decisions data-flow>; derive-from #brief.
...
#dev module small; commit each-slice.
#loop a procedure; order <spec plan build verify commit>.
#dev dod <"meets US acceptance-criteria" "runs no-error" "has test" "committed">.
